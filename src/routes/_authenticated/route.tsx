...
const items = [
  ...
  { to: "/financeiro", label: "Financeiro", icon: Wallet, adminOnly: false },
  { to: "/prontuario", label: "Prontuário Fotos", icon: Camera, adminOnly: false },
  { to: "/previsoes", label: "Previsões IA", icon: LineChart, adminOnly: false },
